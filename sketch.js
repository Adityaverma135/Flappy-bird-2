...
function spawnpoles(){
  if (frameCount%20===0){
    poles=createSprite(550,10,20,200);
    poles.velocityX=-9;
    poles.lifetime=200;
...
function spawnpoles2(){
  if (frameCount%20===0){
  poles2=createSprite(550,420,20,300);
  poles2.velocityX=-9;
  poles2.lifetime=200;  
...
function spawnpoles3(){
  if (frameCount%20===0){
  poles3=createSprite(550,400,20,190);
  poles3.velocityX=-9;
  poles3.lifetime=200;  
...
function spawnpoles4(){
  if (frameCount%20===0){
  poles4=createSprite(550,50,20,200);
  poles4.velocityX=-9;
  poles4.lifetime=200;  
...
function spawnpoles5(){
  if (frameCount%20===0){
  poles5=createSprite(550,100,20,200);
  poles5.velocityX=-9;
  poles5.lifetime=200;  
...
if (frameCount%20===0){
  poles6=createSprite(550,450,20,150);
  poles6.velocityX=-9;
  poles6.lifetime=200;
